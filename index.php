...
<article id='videos'>
    ...
    <ul>
            ...
            <div class="viewMe">
                <div class="videoFigure">
                    <div id="pix<?php echo $n ?>"
                        ...
                        class="clickMe" title='click to play' data-number="<?php echo $n ?>"
        ...
        <li>
            ...
            <p><span class="videoTitles">Video Aufnahmegerät: </span><span><?php echo $video_Aufnahmegeraet;?></span>
            </p>
            <?php endif;?>

            <?php if ($audio_Aufnahmegeraet!='') :?>
            <p><span class="videoTitles">Audio Aufnahmegerät: </span><span><?php echo $audio_Aufnahmegeraet;?></span>
            </p>
            <?php endif;?>
    ...
    ?>
        ...
        <li>
            <div class="entry-content">
                ...
                <?php if ( $url!='#' ) : ?>
                <p><a href="<?php echo $url?>" target="_blank" title="<?php echo $url?> ansehen"><?php echo $url?></a>
                </p>
                <?php endif;?>
                <!--             the_content:   -->
                <?php the_content(); ?>
